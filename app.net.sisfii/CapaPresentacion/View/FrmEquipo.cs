     ...
     MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Helper.PrintToExcel(dgvEquipos);
                }
                else
                {
        ...
        private void ImprimirActividadGeneral(ImpresionEquipo l)
        {
        ...
        public DocumentoElectronico Imprimir(ImpresionEquipo l)
        {
            try
            {
        ...
        private PdfDocument ImprimirContenido(ImpresionEquipo l)
        {
